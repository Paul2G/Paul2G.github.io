  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        contrast: {
          DEFAULT: withOpacityValue("--rgb-value-contrast"),
          50: withOpacityValue("--rgb-value-contrast-50"),
          100: withOpacityValue("--rgb-value-contrast-100"),
          200: withOpacityValue("--rgb-value-contrast-200"),
          300: withOpacityValue("--rgb-value-contrast-300"),
          400: withOpacityValue("--rgb-value-contrast-400"),
          500: withOpacityValue("--rgb-value-contrast-500"),
          600: withOpacityValue("--rgb-value-contrast-600"),
          700: withOpacityValue("--rgb-value-contrast-700"),
          800: withOpacityValue("--rgb-value-contrast-800"),
          900: withOpacityValue("--rgb-value-contrast-900"),
          950: withOpacityValue("--rgb-value-contrast-950"),
        },
